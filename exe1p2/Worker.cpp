...
float Worker::salaryCalc() {
    ...
    int const LEVEL1 = 100, LEVEL2 = 150, LEVEL3 = 400, LEVEL4 = 300, LEVEL5=400;
    ...
    if (income <= 1000) {//if salary is below 1000
        ...
        return finalSalary + LEVEL1 + (income - 1000) * 0.15;
    }
    else if (income <= 4000) {//if salary is between 2000 and 4000
        return finalSalary + LEVEL1 + LEVEL2 + (income - 2000) * 0.2;
    }
    else if (income <= 5000) {//if salary is between 4000 and 5000
        return finalSalary + LEVEL1 + LEVEL2 + LEVEL3 + (income - 4000) * 0.3;
    }
    //if salary is GREATER than 5000
    return finalSalary + LEVEL1 + LEVEL2 + LEVEL3 + LEVEL4 + (income - 5000) * 0.4;
}
